          ...
          <div className="home__product-models">
            <div>
              ...
              <p className="home__product__electro-grey">
                Every Cycles is equipped with an electric motor that lasts up to
                120 hours. The battery is recharged with your energy spent
                pedaling.
              </p>
            </div>
            <div>
              ...
              <p className="home__product__electro-grey">
                We know how precious your Cycles is, so we've added trackers and
