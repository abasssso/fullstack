    ...
    return <div>
        <div className="home__background">
            <div className="home__hero">
                <div className="home__left">
                    <h1 className="home__title">Bikes made
                        under Measure<span style={{color: "#FFBB00"}}>.</span></h1>
                    <p className="home__subtitle">High precision and quality bicycles, custom made for the customer.
                        Explore the
                        world at your
                        speed with Cycles.
                    </p>
                    <button className="home__btn">SELECT YOURS</button>
                </div>
                <img className="home__img" src={bike} width="550" height="700" alt="bike"/>
            </div>
        </div>
        <div className="home__list">
            <div>
                <p className="home__list-title">Choose yours<span style={{color: "#FFBB00"}}>.</span></p>
            </div>
        ...
        <div className="home__product-background">
            <div className="home__product-text">
                ...
                <h2 className="home__product-subtitle">you choose your colors and components.</h2>
                <p className="home__product-info">Each Cycles is unique and has its own identity. The measurements will
                    be exact for your body and
                    height, ensuring greater comfort and ergonomics in your pedaling. You can also completely customize
                    your colors.</p>
                ...
                <div className="home__product-models">
                    <div>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <defs>
                                <linearGradient id="paint0_linear_11_54" x1="12" y1="1" x2="12" y2="23"
                        ...
                        <p className="home__product__electro-grey">Every Cycles is equipped with an electric motor that lasts up to 120 hours. The battery is
                            recharged with your energy spent pedaling.</p>
                    </div>
                    <div>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                            ...
                            <defs>
                                <linearGradient id="paint0_linear_11_56" x1="12" y1="1" x2="12" y2="23"
                                                gradientUnits="userSpaceOnUse">
                                    <stop stopColor="#FFBF00"/>
                                    <stop offset="1" stopColor="#F2A50C"/>
                                </linearGradient>
                        ...
                        <p className="home__product__electro-grey">We know how precious your Cycles is, so we've added trackers and anti-theft systems to ensure
                            your peace of mind.</p>
                    </div>
                </div>
            </div>
            <div>
                <img className="home__product-img" src={blackImage} alt="" width={700} height={1120}/>
            </div>
        </div>
    </div>;
};
